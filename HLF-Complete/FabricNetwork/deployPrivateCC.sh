...
export COLL_CONFIG=${PWD}/artifacts/src/github.com/privateCollection.json
CC_RUNTIME_LANGUAGE="node"
VERSION="1"
SEQUENCE="1"
CC_SRC_PATH="./artifacts/src/github.com/test-private-chaincode"
CC_NAME="test-private-cc-1"
...
chaincodeInvoke() {
	...
	export PAYLOAD=$(echo -n "this is our payload" | base64 | tr -d \\n)
    ...
    peer chaincode invoke -o localhost:7050 \
        ...
        --peerAddresses localhost:7051 --tlsRootCertFiles $PEER0_ORG1_CA \
        --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA   \
	-c '{"function": "saveDetails","Args":["org-collection","PRV0001", "{\"Name\": \"John\", \"Place\": \"India\"}"]}' \
	--transient "{\"payload\":\"$PAYLOAD\"}"
}

chaincodeQuery() {
    setGlobalsForPeer0Org1
    peer chaincode query -C $CHANNEL_NAME -n ${CC_NAME} -c '{"function": "getDetails","Args":["org-collection","PRV0001"]}'
}

packageSetup(){
    cd ${PWD}/artifacts/src/github.com/test-private-chaincode
    npm install 
    cd -
}
